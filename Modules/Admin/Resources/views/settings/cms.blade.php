            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="pheading" style="margin-bottom: 20px;">
                        <h2><a href="{{ route('admin.settings') }}"><i class="las la-arrow-left"></i></a> Pages Management</h2>
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    <div class="order-conf">
                        ...
                        <form action="{{ route('admin.settings.cms') }}" name="form-add" onsubmit="return false;">
                            @csrf
                ...
                <div class="col-md-4">
                    <div class="order-list">
                        ...
                        <div class="cms-list">
                            <?php
                            echo view('admin::settings.cms-list', compact('data'));
                            ?>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function get_cms_listing(id) {
            $('#cover-spin').show();
            $.ajax({
                url: BASE_URL + '/settings/cms-list',
                type: 'GET',
                data: {
                    'action': 'list',
                    'id': id
