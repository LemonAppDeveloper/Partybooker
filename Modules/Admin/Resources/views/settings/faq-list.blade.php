            ...
            <div class="option">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <li><a class="dropdown-item btn-delete-faq" data-id="<?php echo isset($value['id']) ? $value['id'] : ''; ?>" data-url="{{route('admin.settings.faq.delete')}}" href="javascript:void(0);">Delete</a></li>
                    </ul>
                </div>
            </div>
        </div>
