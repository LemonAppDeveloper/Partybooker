            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="pheading" style="margin-bottom: 20px;">
                        <h2><a href="{{ route('admin.settings') }}"><i class="las la-arrow-left"></i></a> Notification Management</h2>
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function get_notification_listing(id) {
            $('#cover-spin').show();
            $.ajax({
                url: BASE_URL + '/settings/notification-list',
                type: 'GET',
                data: {
                    'action': 'list',
                    'id': id
