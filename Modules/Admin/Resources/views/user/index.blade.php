                ...
                <div class="col-md-12">
                    <div class="order-derails">
                        <div class="order-head">
                            <h3>Users Details</h3>
                            <a href="{{ url('/') }}/admin/users/export/1"
                                class="btn btn-info btn-theme text-white">Export</a>
                        </div>
                        <div class="order-search">
                            ...
                            <div class="input-group d-none">
                                <span class="input-group-append input-group-addon">
                                    <span class="input-group-text"><img src="{{ asset('admin-assets/images/icon.png') }}"
                                            alt="icon"></span>
                                </span>
                                <select class="form-control">
                                    ...
                                    @foreach ($users as $user)
                                        <tr data-id="{{ $user['id'] }}" data-url="{{ route('user-info') }}">
                                            ...
                                            <td>
                                                ...
                                                @else
                                                @endif
                                                <button class="btn btn-danger btn-sm btn-delete-user" data-table="users"
