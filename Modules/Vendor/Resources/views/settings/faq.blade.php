            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="pheading" style="margin-bottom: 20px;">
                        <h2><a href="{{ route('vender.configration') }}"><i class="las la-arrow-left"></i></a> FAQ Management</h2>
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    <div class="order-conf">
                        ...
                        <form action="{{ route('vender.configration.faq') }}" name="form-add" onsubmit="return false;">
                            @csrf
                ...
                <div class="col-md-4">
                    <div class="list-area">
                        <div class="listarea-heading">
                            <h2>FAQs</h2>
                            <a style="display: none;" href="#">Add</a>
                        </div>
                        <div class="scroll-list">
                            <div class="faq-list">
                                <?php
                                echo view('vendor::settings.faq-list', compact('data'));
                                ?>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        function get_faq_listing(id) {
            $('#cover-spin').show();
            $.ajax({
                url: '/vendor/configration/faq-list',
                type: 'GET',
                data: {
                    'action': 'list',
                    'id': id
