                        ...
                        <div class="col-md-4">
                            <div class="my-party notupdated">
                                <div class="myparty-head">
                                    ...
                                    <a href="#"><i class="las la-briefcase"></i></a>
                                </div>
                                <p class="details">Details</p>
                                ...
                                <ul>
                                    <li>
                                        <a href="#" class="add-image"><i class="las la-plus"></i></a>
                                        <p>Vendors</p>
                                    </li>
                                    <li>
                                        <a href="#" class="add-image"><i class="las la-plus"></i></a>
                                ...
                                <a href="#" class="btn-trans">View my party</a>
                            </div>
                        </div>
                        */ ?>
                        </div>
                            ...
                            <div class="party-banner" style="background-image:url({{ asset('assets/images/party-banner.png') }})">
                                <div class="row">
                                    <div class="col-md-4 offset-md-8">
                                        ...
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#organizeparty">
                                            Organize Party
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="slick-carousel">
                        ...
                        <div class="cat-list-box">
                            ...
                            <div class="cat-body">
                                ...
                                <a href="#" class="view-all-review">View details</a>
                            </div>
                        </div>
